...
local Window = Rayfield:CreateWindow({
   Name = "Inicializador Kakah Menu Blox Fruits",
   LoadingTitle = "Kakah Menu Premium",
   LoadingSubtitle = "by KAKAZiT",
   ConfigurationSaving = {
      Enabled = true,
   ...
   KeySettings = {
      Title = "Kakah Menu Blox Fruits",
      Subtitle = "Sistema de Chaves",
      Note = "Seja bem-vindo ao Kakah Menu Blox Fruits!",
      FileName = "KakahMenuKey",
      SaveKey = true,
...
local Tab = Window:CreateTab("Acessos", 4483362458) -- Title, Image
...
local Button = Tab:CreateButton({
    Name = "Kakah Menu V1",
    Info = "Para Inicializar o Menu V1", -- Speaks for itself, Remove if none.
    Interact = 'Changable',
    Callback = function()
        if game:GetService("CoreGui"):FindFirstChild("Kakah Menu V1") then
            game:GetService("CoreGui"):FindFirstChild("Kakah Menu V1"):Destroy()
        end
        local DiscordLib = {}
        ...
        local serv = win:Server("Kakah Menu V1","")
        
        local AutoFarm = serv:Channel("Inicio", "http://www.roblox.com/asset/?id=7040391851")
        ...
        local Stats = serv:Channel("Status","http://www.roblox.com/asset/?id=7040410130")
        ...
        local Tp = serv:Channel("Teleportes","http://www.roblox.com/asset/?id=7044226690")
        ...
        local Setting = serv:Channel("Configs","http://www.roblox.com/asset/?id=7040347038")
        ...
        Setting:Button("Copy Link Discord : Kakah Menu V1", function()
            setclipboard("https://discord.gg/kakazit-community-845719485653581834")
        end)
...
local Button = Tab:CreateButton({
    ...
    Callback = function()
     ...
     local Tab = Window:CreateTab("Configurações", 4483362459) -- Title, Image
